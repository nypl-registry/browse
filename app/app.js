  ...
  render () {
    return (
      <div>
        ...
        <Hero
          textMiddleClass='homepage-hero-middleText'
          image={heroImages}
          textUpper='NYPL Labs'
          textMiddle='data.nypl'
          textLower='' />
        <div className='container'>
          <div className='row'>
            <div className='tweleve columns'>
              <div className='homepage-text-blurb'>
                This site is the public side of an ongoing data project at <a href='http://labs.nypl.org'>NYPL Labs</a>. Feel free to explore but please keep in mind this
                site may break or go offline at anytime. While we are working towards persistent URIs for our resources we are not quite there yet, so please do not reuse
                any of the identifiers found on this site.
                <br/>
                <br/>
                <div>
                  <Link to='/agents'> Explore Agents
                  </Link>
                </div>
                <div>
                  Explore Terms (coming soon)
                </div>
                <div>
                  <Link to='/resources'> Explore Resources
                  </Link>
                </div>
              </div>
            </div>
